...
public:
	...
	struct ParticleCountEntryRequest {
		bool requested = false;
		ParticleColorChannel channel =
			ParticleColorChannel::Red;
	};
	...
	const ParticleCountEntryRequest& getParticleCountEntryRequest() const { return m_particleCountEntryRequest; }
...
private:
	...
	ParticleCountEntryRequest m_particleCountEntryRequest;
